                    ...
                    <div class="row match-height">
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                ...
                                <h4 class="card-title">Eye Segment</h4>
                                </div>
                            ...
                            <form id="Eye_segment" action="#" method="post"> 
...
$( document ).ready(function() {
   table= $('#tableid').DataTable( {
          'processing': true,
          'serverSide': true,
          'ajax':'<?=base_url()?>master/Eye_segment/ajax_call',
          'columns': [
             { data: 'slno' },
             { data: 'name' },
             { data: 'description' },
...
function getinstruction(val,sel=0,ins=0)
{
    if(val>0)
    {
        $("#overlay").fadeIn(300);
         $.ajax({
            type: "POST",
            url: 'Eye_segment/getinstruction',
            dataType: "json",
           data: {Eye_segment_category_id: val,ins: ins,csrf_test_name:$('#csrf_test_name').val()},
            success: function(data){
              ...
              } else if(data.error_message) 
              {
                ...
                if(sel==0){
                   $('#Eye_segment_instruction_id').html(data.datas);
                }
                else
                {
                    $('#Eye_segment_instruction_idd').html(data.datas);
                }
...
function savedata()
{
    if( $("#name").val()=='') {
        ...
        $("#overlay").fadeIn(300);
         $.ajax({
            type: "POST",
            url: 'Eye_segment/savedata',
            dataType: "json",
            data: $('#Eye_segment').serialize(),
            success: function(data){
                $("#overlay").fadeOut(300);
               if(data.msg != ''){
...
function editdata(val)
{
    ...
    {
         $("#overlay").fadeIn(300);
         $('#Eye_segment_instruction_idd').val('');
         $.ajax({
            type: "POST",
            url: 'Eye_segment/editdata',
            dataType: "json",
            ...
            success: function(data){
               ...
               if(data.msg != ''){
                 ...
                 getinstruction(data.Eye_segment_category_id,sel=1,data.Eye_segment_instruction_id);
