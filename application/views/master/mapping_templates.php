                    ...
                    <div class="row match-height">
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                ...
                                <h4 class="card-title">Mapping Templates</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="base-tab1" data-toggle="tab" aria-controls="tab1" href="#tab1" aria-expanded="true">Add Medicine Templates</a>
                                            </li>
                                            <li class="nav-item">
                            ...
                            <form id="Mapping_templates" action="#" method="post"> 
                                     ...
                                     <div class="col-md-6">
                                        <div class="form-group">
                                          ...
                                          <select class="form-control select2" name="item_id" id="item_id"  style="width:100%;">
                                            ...
                                            ?>
                                                <option value="<?php print $data['medicine_id'] ?>"><?php print $data['name'] ?></option>
                                            <?php
                                              }
                                            }
                                            ?>
                                       ...
                                       <div class="col-md-6">
                                        <div class="form-group">
                                           ...
                                           <select class="form-control select2" id="medicine_templates_id" name="medicine_templates_id" style="width:100%;">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control select2" name="instruction_id" id="instruction_id" style="width:100%;" onchange="loadpreop_ins($(this).val());">
                                            ...
                                            if($getmedins)
                                            {
                                                foreach ($getmedins as $datamedins) {
                                                   $hmmdins.='<option value="'.$datamedins['medicine_instruction_id'].'~'.$datamedins['name'].'~'.$datamedins['days'].'">'.$datamedins['name'].'</option>';
                                                }
                                            }
                                            ?>
                                            <?php echo $hmmdins; ?>
                                    ...
                                    <div class="col-md-8">
                                       <table class="table table-striped table-bordered table-hover" id="pro_ins_tab">
                                           <thead>
                                               <tr>
                                                   <th>Instruction</th>
                                                   <th>No of Days</th>
...
$( document ).ready(function() {
   table= $('#tableid').DataTable( {
          'processing': true,
          'serverSide': true,
          'ajax':'<?=base_url()?>master/Mapping_templates/ajax_call',
          'columns': [
             { data: 'slno' },
             { data: 'name' },
             { data: 'description' },
...
function savedata()
{
    if( $("#name").val()=='') {
        ...
        $("#overlay").fadeIn(300);
         $.ajax({
            type: "POST",
            url: 'Mapping_templates/savedata',
            dataType: "json",
            data: $('#Mapping_templates').serialize(),
...
function editdata(val)
{
    if(val>0)
    {
         ...
         $.ajax({
            type: "POST",
            url: 'Mapping_templates/editdata',
            dataType: "json",
            ...
            success: function(data){
               ...
               if(data.msg != ''){
                 ...
                 $('.modal-title').html('Edit Mapping Templates');
                  $(".select2").select2();
              } else if(data.error != ''){
                Swal.fire({title:"Warning!",text:""+data.error+"",type:"warning",confirmButtonClass:"btn btn-primary",buttonsStyling:!1});
              } else if(data.error_message) 
...
function updatedataval()
{
        ...
        $("#overlay").fadeIn(300);
         $.ajax({
            type: "POST",
            url: 'Mapping_templates/updatedata',
            dataType: "json",
          ...
          Swal.fire({title:"Are you sure?",
            ...
            buttonsStyling:!1}).then((function(t){
             ...
             $("#overlay").fadeIn(300);
                   $.ajax({
            type: "POST",
            url: 'Mapping_templates/deletedata',
            dataType: "json",
            data: {getid: val,csrf_test_name:$('#csrf_test_name').val()},
            success: function(data){
                $("#overlay").fadeOut(300);
  ...
  function loadpreop_ins(val)
{
    ...
    if(myArray)
    {
           $('#pro_ins_tab').children('tbody').append('<tr>\n\
                                       <td><input type="hidden"  name="med_ins_id[]" value="'+myArray[0]+'">'+myArray[1]+'</td>\n\
                                       <td>'+myArray[2]+'</td>\n\
  ...
  function loadpreop_ins1(val)
{
    myArray = val.split("~");

    if(myArray)
    {
           $('#pro_ins_tab1').children('tbody').append('<tr>\n\
                                       <td><input type="hidden"  name="med_ins_id[]" value="'+myArray[0]+'">'+myArray[1]+'</td>\n\
                                       <td>'+myArray[2]+'</td>\n\
                                       <td><a href="#" onclick="$(this).parent().parent().remove();"><button class="btn btn-danger btnDelete btn-sm"><i class="la la-trash"></i></button></a></td>\n\
                                       </tr>'); 
