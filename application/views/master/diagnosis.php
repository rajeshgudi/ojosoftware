                    ...
                    <div class="row match-height">
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                ...
                                <h4 class="card-title">Diagnosis Master</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="base-tab1" data-toggle="tab" aria-controls="tab1" href="#tab1" aria-expanded="true">Add Diagnosis</a>
                                            </li>
                                            <li class="nav-item">
                            ...
                            <form id="Diagnosis" action="#" method="post"> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  id="ipd_code_le" name="ipd_code_le" >
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="lastname">IPD 10 code RE:</label>
                                            <input type="text" class="form-control"  id="ipd_code_re" name="ipd_code_re" >
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="lastname">IPD 10 code BE: </label>
                                            <input type="text" class="form-control"  id="ipd_code_be" name="ipd_code_be" >
                                        </div>
                                    </div>
...
$( document ).ready(function() {
   table= $('#tableid').DataTable( {
          'processing': true,
          'serverSide': true,
          'ajax':'<?=base_url()?>master/Diagnosis/ajax_call',
          'columns': [
             { data: 'slno' },
             { data: 'name' },
...
function savedata()
{
    if( $("#name").val()=='') {
        ...
        $("#overlay").fadeIn(300);
         $.ajax({
            type: "POST",
            url: 'Diagnosis/savedata',
            dataType: "json",
            data: $('#Diagnosis').serialize(),
