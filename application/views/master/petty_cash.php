                 ...
                 <section id="basic-tabs-components">
                    <div class="row match-height">
                        <div class="col-xl-12 col-lg-12">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="base-tab1" data-toggle="tab" aria-controls="tab1" href="#tab1" aria-expanded="true">Add Petty</a>
                                            </li>
                                            <li class="nav-item">
                            ...
                            <form id="Petty_cash" action="#" method="post"> 
                                <input type="hidden" name="csrf_test_name" id="csrf_test_name" value="<?php echo $this->security->get_csrf_hash(); ?>"> 
                                <div class="row">
                                     <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="lastname">Pay Type: <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="lastname">Vendor Name: <span class="text-danger">*</span></label>
                                            <input type="text" name="petty_cash_name" id="petty_cash_name" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="lastname">Amount: <span class="text-danger">*</span></label>
                                            <input type="text" name="petty_amount" id="petty_amount" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="lastname">Date: <span class="text-danger">*</span></label>
                                            <input type="date" name="petty_date" id="petty_date" class="form-control pay_date">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                     <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="lastname">Petty Cash Receipt No: <span class="text-danger">*</span></label>
                                            <input type="text" name="petty_receipt_no" id="petty_receipt_no" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="lastname">Authorization Person Name: <span class="text-danger">*</span></label>
                                            <input type="text" name="auth_person" id="auth_person" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="lastname">Attachment: </label>
                                            <input style="height: 44px;" type="file" name="photo" id="photo" class="form-control">
                                        </div>
                                    </div>
                                                     ...
                                                     <table id="tableid" class="table table-striped table-bordered opticaltable-list" style="width: 100%;">
                                                        <thead>
                                                          <tr>
                                                            ...
                                                            <th>Amount</th>
                                                            <th>Date</th>
                                                            <th>Authorization Person Name</th>
                                                            <th>Description</th>
                                                            <th>Attachment</th>
                                                            <th>Delete</th>
                                                          </tr>
...
$( document ).ready(function() {
   table= $('#tableid').DataTable( {
          'processing': true,
          'serverSide': true,
          'ajax':'<?=base_url()?>master/Petty_cash/ajax_call',
          'columns': [
             { data: 'slno' },
             { data: 'pay_type' },
             { data: 'petty_receipt_no' },
...
function savedata()
{
    if( $("#name").val()=='') {
        ...
        let data = new FormData($("#Petty_cash")[0]);
        $("#overlay").fadeIn(300);
        saveurl="Petty_cash/savedata";
         $.ajax({
            type: "POST",
            url: saveurl,
            dataType: "json",
...
function savdfdedata()
{
    if( $("#name").val()=='') {
        ...
        $("#overlay").fadeIn(300);
         $.ajax({
            type: "POST",
            url: 'Petty_cash/savedata',
            dataType: "json",
            data: $('#Petty_cash').serialize(),
            success: function(data){
                $("#overlay").fadeOut(300);
               if(data.msg != ''){
               Swal.fire({title:"",text:""+data.msg+"",type:"success",confirmButtonClass:"btn btn-success",buttonsStyling:!1});
