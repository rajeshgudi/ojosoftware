           ...
           <td style="width:27%;line-height:10px;text-align:center;font-weight:bold;">
              ...
              <table  width="100%" style="line-height:10px;margin-top:0px;font-size: 13;border: 1px solid black"> 
                ...
                <tr>
                    ...
                    <td style="line-height:15px;text-align: left;width:23%;font-size: 12px">  </td>
                </tr>
         </table>
                ...
                <table  width="100%" style="line-height:10px;margin-top:0px;font-size: 13;border:  1px solid black"> 
                  <tr>
                    ...
                    <td style="line-height:15px;text-align: left;width:23%;font-size: 12px">: <?=$discharge_date?>  </td>
                </tr>
               ...
               <table  width="100%" style="line-height:10px;margin-top:0px;font-size: 13;border:  1px solid black"> 
                ...
                <tr>
                    ...
                    <td style="line-height:15px;text-align: left;width:23%;font-size: 12px">: <?=$datesur?>  </td>
                </tr>
               </table>
               <br>
            ...
            <div class="row">
                 <div class="hytclass">
                 <table  width="100%" style="line-height:10px;margin-top:0px;font-size: 15;"> 
                     <tr>
                     ...
                     <tr>
                         <td  class="cls1">Investigation Performed</td>
                         <td class="cls2">: <?=$investigation?> </td>
                     </tr>
                     <tr>
                         <td  class="cls1">BP</td>
                ...
                <table  width="100%" style="line-height:10px;margin-top:0px;font-size: 14px;border:  1px solid black;border-collapse: collapse;" border="1"> 
                    <tr>
                            ...
                            foreach($medi as $dataval)
                            {
                                ?>
                                    <tr>
                                        ...
                                        <td valign="top" class="cls5"><?php echo $dataval['instruction']; ?><br/><?php echo nl2br($dataval['description']); ?></td>
                ...
                <table  width="100%" style="line-height:10px;margin-top:0px;font-size: 14;"> 
                     <tr>
