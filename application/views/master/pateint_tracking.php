...
<form id="upload_file1" action="#" method="post"> 
      <input type="hidden" name="csrf_test_name" id="csrf_test_name" value="<?php echo $this->security->get_csrf_hash(); ?>"> 
 <div id="up_modal1" class="modal fade" role="dialog">
        <div class="modal-dialog modal-sm">
          <input type="hidden" id="excross" name="excross">
        <!-- Modal content-->
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="form-group">
                          <div class="col-md-12">
                              ...
                              <select class="form-control select2" name="cross_doctor_id" id="cross_doctor_id">
                    ...
                    <div class="form-group">
                          <div class="col-md-12">
                              ...
                              <textarea class="form-control" name="cross_description" id="cross_description"></textarea>
                          </div>
                ...
                <button id="save" class="btn btn-primary btn-sm" type="button" onclick="save_cross();">Save</button>
     ...
     <div class="col-12 col-xl-3">
        <div class="card">
            <div class="card-header bg-danger bg-lighten-5">
                <h4 class="card-title">PHARMCY Today's Collection</h4>
                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                <div class="heading-elements">
...
<div class="row"> <div class="col-xl-3 col-lg-6 col-12">
        ...
        <div class="card-body">
          <div class="media d-flex">
            <div class="media-body text-white text-left">
              ...
              <span>Today's Followup Patients</span>
            </div>
            <div class="align-self-center">
              <i class="icon-users text-white font-large-2 float-right"></i>
            </div>
        ...
        <div class="card-body">
          <div class="media d-flex">
            <div class="media-body text-white text-left">
              ...
              <span>Optometry Waiting Patients</span>
            </div>
            <div class="align-self-center">
              <i class="icon-users text-white font-large-2 float-right"></i>
            </div>
                                                    ...
                                                    <div class="card-body">
                                                      <div class="media d-flex">
                                                        <div class="media-body text-white text-left">
                                                          ...
                                                          <span>Consultation Inprogress</span>
                                                        </div>
                                                        <div class="align-self-center">
                                                          <i class="icon-users text-white font-large-2 float-right"></i>
                                                        </div>
   ...
   <div class="card-content card">
      <div class="card-body">
          <ul class="nav nav-tabs">
            ...
            <?php } ?>
              <li class="nav-item">
                  <a class="nav-link" id="base-tab6" data-toggle="tab" aria-controls="tab6" href="#tab6" aria-expanded="false">Cross Referral <span id="cross_cnt" style="font-size: 16px;" class="badge badge-pill badge badge-success ml-1">0</span></a>
              </li>
          </ul>
                ...
                <div role="tabpanel" class="tab-pane" id="tab6" aria-expanded="true" aria-labelledby="base-tab6">
                     <div class="tab-pane" id="tab6" aria-labelledby="base-tab6">
                             ...
                             <div class="col-sm-3 col-md-3">
                                ...
                                <div class="col-md-4">
                                    <input style="height: 43px;" type="date" name="corss_search_date" id="corss_search_date" class="form-control search_date">
                                </div>
                                <div class="col-md-4">
                                    <button onclick="getcross_refdata()" class="btn btn-icon btn-warning mr-1 mb-1" type="button"><i class="la la-search"></i></button>
                                </div>
                            </div>
                               <div class="table-responsive" id="cross_ref_data">
                                </div>
                      </div>
                </div>
...
function crossrefex(exid)
{
  if(exid>0)
    {
        tit='Cross Referral';
        $('#up_modal1').modal('show');
        $('.modal-title').html(tit);
        $('#excross').val(exid);
    }
}
function showallpatient_details(val=0)
{
  ...
  {
    docid=$('#all_cons'+val).val();
    curdate=$('#date_pic'+val).val();
...
function save_cross()
{
  $("#overlay").fadeIn(300);
         $.ajax({
            type: "POST",
            url: '<?php echo base_url(); ?>transaction/Examination/cross_ref_save',
            dataType: "json",
            data : $('#upload_file1').serialize(),
            success: function(data){
                $("#overlay").fadeOut(300);
               if(data.msg != '')
               {
...
function getcross_refdata(val=1)
{
          $('#cross_cnt').html(0);
           $('#cross_ref_data').html('');
        $("#overlay").fadeIn(300);
         $.ajax({
            type: "POST",
            url: '<?php echo base_url(); ?>transaction/Examination/Get_cross_data',
            dataType: "json",
            data: {corss_search_date:$('#corss_search_date').val(),csrf_test_name:$('#csrf_test_name').val()},
            success: function(data){
                $("#overlay").fadeOut(300);
               if(data.msg != '')
               {
                  $('#cross_cnt').html(data.crosscnt);
