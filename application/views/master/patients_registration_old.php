                                ...
                                <div class="card-content" style="margin-top: -32px;">
                                    <div class="card-body">
                                        <ul class="nav nav-tabs">
                                           ...
                                           <?php  $host_tvm = explode('.',$_SERVER['HTTP_HOST'])[0]; if($host_tvm=='deh'){ ?>
                                            <li class="nav-item">
...
function search_tele()
{
     ...
     $.ajax({
            ...
            dataType: "json",
            data: {tele_fil_doctor_id:$('#tele_fil_doctor_id').val(),from_date:$('#tele_fromdate').val(),to_date:$('#tele_todate').val(),csrf_test_name:$('#csrf_test_name').val()},
            success: function(data){
...
function getpateintdetails() 
{
    ...
    $('#p_date').html('');
     ...
     $.ajax({
            ...
            dataType: "json",
            data: {sdate:$('#search_date').val(),sur_doctorid:$('#sur_doctorid').val(),csrf_test_name:$('#csrf_test_name').val()},
            success: function(data){
...
function getpateintdetails_camp() 
{
    $('#camplist').html('');
     ...
     $.ajax({
            ...
            dataType: "json",
            data: {sdate1:$('#search_date_camp1').val(),sdate2:$('#search_date_camp2').val(),csrf_test_name:$('#csrf_test_name').val()},
            success: function(data){
                $("#overlay").fadeOut(300);
               if(data.msg != ''){
  ...
  if($('#pat_idcard').val()>0)
  {
    $("#overlay").fadeIn(300);
     $.ajax({
            ...
            dataType: "json",
            data: {patid: $('#pat_idcard').val(),csrf_test_name:$('#csrf_test_name').val()},
            success: function(data){
                $("#overlay").fadeOut(300);
               if(data.msg != ''){
