                    ...
                    <div class="row match-height">
                        <div class="col-xl-12 col-lg-12">
                            ...
                            <form id="Createuser" action="#" method="post" autocomplete="off"> 
                                ...
                                <div class="row">
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="role" id="role" onchange="getchange();">
                                ...
                                <div class="row" id="doctor_part" style="display:none;">
...
function getchange()
{
  if($('#role').val()==2)
  {
    $('#doctor_part').show(500);
  }
  else
  {
    $('#doctor_part').hide(500);
  }
}
function getchangeedit()
{
  if($('#edit_form #role').val()==2)
  {
    $('#editt_doc').show(500);
  }
  else
