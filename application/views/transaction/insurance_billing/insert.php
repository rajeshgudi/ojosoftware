                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Insurance Billing</h4>
                                </div>
                              ...
                              <div id="last_appointmentdetails" style="margin-bottom: 1%;"></div>
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-striped table-hover" id="productdetails" bquotation="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>Rate</th>
                                                        <th style="display:none;" <?php echo $cls; ?>>Dis Amt</th>
                                                        <th style="display:none;" <?php echo $cls; ?>>Dis Per</th>
                                                        <th>Total Amt</th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" class="form-control" name="ifs_code" id="ifs_code">
                                    </div>
                                </div>
                                <div class="row form-group">
                                <div class="col-md-8">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="net_amount" id="net_amount" class="form-control" readonly style="color: black;font-weight: bold;    font-size: 25px;
    background: antiquewhite;" value="0.00">
                                    </div>
                                </div>
...
$( document ).ready(function() {
   table= $('#tableid').DataTable( {
          'processing': true,
          'serverSide': true,
          'ajax':'<?php echo base_url() ?>transaction/Insurance_billing/ajax_call',
          'columns': [
             { data: 'slno' },
             { data: 'pateint_name' },
             { data: 'invoice_number' },
...
function savedata()
{
     if($("#patient_title_id").val()=='' || $("#bill_date").val()=='' || $("#bill_time").val()=='' || $("#doctor_id").val()=='' ) {
        ...
        $("#overlay").fadeIn(300);
         $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>transaction/Insurance_billing/savedata',
            dataType: "json",
...
function editdata(val)
{
        ...
        getdata='<?php echo base_url() ?>transaction/Insurance_billing/getsavedata';
         $.ajax({
            type: "POST",
            url: getdata,
            dataType: "json",
            ...
            success: function(data){
               ...
               if(data.msg)
               {
                  ...
                  $('#edit_billing_master_id').val(data.msg[0]['insurance_billing_master_id']);

                  $('#claimno').val(data.msg[0]['claimno']);
                  $('#acc_name').val(data.msg[0]['acc_holdername']);
                  $('#bank_name').val(data.msg[0]['bank_name']);
                  $('#acc_no').val(data.msg[0]['acc_no']);
                  $('#ifs_code').val(data.msg[0]['ifs_code']);
                  ...
                  getpatientdetails(data.msg[0]['patient_registration_id']);
...
function updatedataval()
{
        ...
        $("#overlay").fadeIn(300);
         $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>transaction/Insurance_billing/updatedata',
            dataType: "json",
            data: $('#billing').serialize(),
            success: function(data){
                $("#overlay").fadeOut(300);
          ...
          Swal.fire({title:"Are you sure?",
            ...
            buttonsStyling:!1}).then((function(t){
             ...
             $("#overlay").fadeIn(300);
                   $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>transaction/Insurance_billing/deletedata',
            dataType: "json",
...
<td style="display:none;"><select  step="any" name="eye[]" id="eye_'+row_num+'" class="form-control grid_table"  autocomplete="off">\n\
...
<td style="display:none;" '+clsr+'><input type="text" step="any" name="disamt[]" id="disamt_'+row_num+'" class="form-control grid_table" value=""  onKeyUp="calcrow('+row_num+')"   onkeypress="return isFloat(event)" required  autocomplete="off"></td>\n\
<td style="display:none;" '+clsr+'><input type="text" step="any" name="disper[]" id="disper_'+row_num+'" class="form-control grid_table" value=""  onKeyUp="calcrow('+row_num+')"   onkeypress="return isFloat(event)" required  autocomplete="off"></td>\n\
  <td>\n\
         ...
         $.ajax({
            ...
            success: function(data){
               ...
               if(data.msg)
               {
                  ...
                  $('#edit_billing_master_ida').val(data.msg[0]['insurance_billing_master_id']);
                  $('#last_appointmentdetailsa').html(data.msg);
