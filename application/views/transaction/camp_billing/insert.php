                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Camp Billing</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="base-tab1" data-toggle="tab" aria-controls="tab1" href="#tab1" aria-expanded="true"><l id="tab_tit">Add Camp Billing<l></a>
                                            </li>
                                ...
                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2 col-md-3" style="display: none;">
                                                          ...
                                                          <div class="col-sm-2 col-md-6">
                                                            <div class="form-group">
                                                                <label for="lastname">Patient: <span class="text-danger">*</span></label>
                                                               <select style="width:100%;" class="form-control form-control-xl input-xl select2" name="patient_registration_id" id="patient_registration_id">
...
$( document ).ready(function() {
   table= $('#tableid').DataTable( {
          'processing': true,
          'serverSide': true,
          'ajax':'<?php echo base_url() ?>transaction/Camp_billing/ajax_call',
          'columns': [
             { data: 'slno' },
             { data: 'namecamp' },
             { data: 'invoice_number' },
...
function savedata()
{
     if($("#patient_title_id").val()=='' || $("#bill_date").val()=='' || $("#bill_time").val()=='' || $("#doctor_id").val()=='' ) {
        ...
        $("#overlay").fadeIn(300);
         $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>transaction/Camp_billing/savedata',
            dataType: "json",
...
function editdata(val)
{
        ...
        getdata='<?php echo base_url() ?>transaction/Camp_billing/getsavedata';
         $.ajax({
            type: "POST",
            url: getdata,
            dataType: "json",
            ...
            success: function(data){
               ...
               {
                  $('#base-tab1').click(); 
                  $('#tab_tit').html('Edit Camp Billing');
...
function updatedataval()
{
        ...
        $("#overlay").fadeIn(300);
         $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>transaction/Camp_billing/updatedata',
            dataType: "json",
            data: $('#billing').serialize(),
            success: function(data){
                $("#overlay").fadeOut(300);
          ...
          Swal.fire({title:"Are you sure?",
            ...
            buttonsStyling:!1}).then((function(t){
             ...
             $("#overlay").fadeIn(300);
                   $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>transaction/Camp_billing/deletedata',
            dataType: "json",
...
function calcneta()
 ...
 function printdata(billing_id){
         ...
         $('<form target="_blank"  method="post" action="<?php echo base_url() ?>transaction/Camp_billing/print_billing/"><input name="billing_id" value="'+billing_id+'"/><input name="csrf_test_name" value="'+$('#csrf_test_name').val()+'"></form>').appendTo('body').submit().remove();
...
$('.saverq').hide();
        ...
        getselectedval(1);
        csrf=$('#csrf_test_name').val();
        getdata='<?php echo base_url() ?>transaction/Camp_billing/getsavedataAdjust';
         $.ajax({
            type: "POST",
            url: getdata,
            dataType: "json",
