                            ...
                            <div role="tabpanel" class="tab-pane active" id="active21" aria-labelledby="active2-pill1" aria-expanded="true">
                                                    ...
                                                    <table class="table table-hover" id="productdetails">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th style="display:none;" id="productdetails">Eye</th>
                                                                <th>Delete</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                ...
                                <form id="examination_addpartisaveform" action="#" method="post">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label>Select Doctor</label>
                                        <select class="form-control select2" name="las_doctorid" id="las_doctorid">
                                            <option value="">Select Doctor</option>
                                            <?php if ($doctors) {
                                                foreach ($doctors as $data) {
                                            ?>
                                    ...
                                    <div class="col-md-4">
                                        <label>Select Doctor</label>
                                        <select class="form-control select2" name="inj_doctorid" id="inj_doctorid">
                                            <option value="">Select Doctor</option>
                                            <?php if ($doctors) {
                                                foreach ($doctors as $data) {
                                            ?>
                                    ...
                                    <select class="form-control select2" name="inj_coun" id="inj_coun">
                                      ...
                                      <h2 style="background: beige;padding: 8px;text-align: center;font-weight: bold;">Investigation Details</h2>
                                         <div class="row">
                                            <div class="col-sm-3 col-md-3 docscr">
                                            <div class="form-group">
                                                    ...
                                                    <table class="table table-bordered table-hover scroll" id="complaintidd" style="width:100%;">
                                                        <thead>
                                                            ...
                                                            <tr style="position: relative;">
                                                                ...
                                                                <th style="width:60%;">Complaints</th>
                                                                <th style="display:none;">EYE</th>
...
<span class="btn btn-outline-info btn-min-width  mr-1 mb-1" style="cursor: pointer;float:right;" onclick="addparti()">Add Particulars</span>
 <span class="btn btn-outline-warning btn-min-width  mr-1 mb-1" style="cursor: pointer;float:right;" onclick="adddiagnosis()">Add diagnosis</span>
 <span class="btn btn-outline-success btn-min-width  mr-1 mb-1" style="cursor: pointer;float:right;" onclick="addmedhistory()">Add Medicine</span> 
  <span class="btn btn-outline-danger btn-min-width  mr-1 mb-1" style="cursor: pointer;float:right;" onclick="addhistory()">Add History</span>
                                            </div>
                            ...
                            <div class="row">
                                    <div clas="col-md-12">
                                        <h3 style="font-weight:500">Past Dental History</h3>
                                    </div>
                               </div>
                               <br/>
                               <div class="row">
                               <div class="col-md-2"><h6 style="margin-top: 10%;"><b>Hard tissue</b></h6></div>
                               <div class="col-md-10"><?php echo  $htmlloopteeth_rev1; ?> <?php echo $htmlloopteeth1; ?></div>
                              </div>
                              <div class="row">
                                <div class="col-md-2"><h6 style="margin-top: 10%;"><b>Hard tissue</b></h6></div>
                                <div class="col-md-10"><?php echo  $htmlloopteeth_rev2; ?> <?php echo $htmlloopteeth2; ?></div>
                             </div>
                            
                               
                               
                               
            <br/><div class="row"><div class="col-md-8"><label>Past Dental History General Remarks</label>
            <textarea class="form-control" name="past_dental_remarks" id="past_dental_remarks"></textarea></div>
            <div class="col-md-4">
                    <label>Dental Instruction</label>
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-md-12">
                                             <div class="form-group">
                                               ...
                                               <textarea class="form-control" name="treatment_plan" id="treatment_plan"></textarea>
                                             </div>
                                          </div>
                                          <div class="col-md-12 form-group">
                                            <button onclick="addtreatmentplan()" style="float:right;font-weight:bold;" type="button" class="btn btn-success">Add Treatment Plan &nbsp;<i class="la la-plus"></i></button>
                                          </div>
                                          <div class="col-md-12">
                                        <table class="table table-bordered table-hover" id="treatmentplantable">
                                            ...
                                            <tbody>
                                              <?php if($doc_examination_id>0)
                                              {
                                                $sql = "select treatment_date,treatment_plan,treament_payment from dental_treatment where  examination_id=$doc_examination_id";
                                                $result_row=$this->db->query($sql); 
                                                $res= $result_row->result_array ();
                                                if($res)
                                                {
                                                    $kl=1;
                                                    foreach ($res as $dataexteeth) 
                                                    { ?>

                                                 <tr>
                                                    <td><input type="date" class="form-control datepic" name="treatment_date[]" id="treatment_date<?php echo $kl; ?>" value="<?php echo $dataexteeth['treatment_date'] ; ?>"></td>
                                                    <td><input type="text" class="form-control" name="treatmentplansection[]" id="treatmentplansection<?php echo $kl; ?>" value="<?php echo $dataexteeth['treatment_plan'] ; ?>"></td>
                                                    <td><input type="text" class="form-control" name="paymentmode[]" id="paymentmode<?php echo $kl; ?>" value="<?php echo $dataexteeth['treament_payment'] ; ?>"></td>
                                                ...
                                                <tr>
                                                    <td><input type="date" class="form-control datepic" name="treatment_date[]" id="treatment_date1"></td>
                                                    <td><input type="text" class="form-control" name="treatmentplansection[]" id="treatmentplansection1"></td>
                                                    <td><input type="text" class="form-control" name="paymentmode[]" id="paymentmode1"></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
                                        ...
                                        <?php if($doc_examination_id>0)
                                              {
                                                ...
                                                ?>
<input type="hidden" id="treatmentrow" value="<?php echo $kl; ?>">
                                                <?php
                                              }
                                              else {
                                                ?>
<input type="hidden" id="treatmentrow" value="1">
                                                <?php
                                              }
                                              ?>
                                      ...
                                      <div class="row">
                                             <div class="col-md-12">
                                    <div id="inv_data_show" >
                    <?php  
                    if($doc_examination_id>0)
                     {     
                        $showdata='';
                        $Getdetailstableex=$this->Dental_examination_model->Getdetailstablefr($doc_examination_id);
                        ...
                        ?>
                                           ...
                                           <div class="row">
                                             <div class="col-md-12">
                                    <div id="com_data_show" >
                    <?php  
                    if($doc_examination_id>0)
                     {     
                        $comshowdata='';
                         $complaints=$this->db->query("select * from examination_complaints inner join complaints on examination_complaints.complaints_id=complaints.complaints_id where examination_id=$doc_examination_id")->result();
                         if($complaints)
                         {
                        ...
                        echo $comshowdata;
                        $comshowdatamed='';
                          $medical_history=$this->db->query("select * from examination_medical_history inner join medical_history on examination_medical_history.medical_history_id=medical_history.medical_history_id where examination_id=$doc_examination_id")->result(); 
                          if($medical_history)
                         {
                        ...
                        $hsdhs='';
                          $medical_history_val=$this->db->query("select family_history,drug_history,current_meditation from examination  where examination_id=$doc_examination_id")->result(); 
                        ...
                        ?>
                                                ...
                                                <?php if ($doc_examination_id > 0) { ?>
                                                    <div class="row" style="display:none;">
                                                        <div class="col-md-12">
                                                        <button type="button" onclick="opticaladvice(<?php echo $patient_registration_id; ?>)" class="btn btn-info btn-glow">Optical Advice</button>&nbsp;
                                                ...
                                                <div class="col-md-4">
                                                        <label>Usage</label>
                                                       <select class="form-control select2" name="usage_ex" id="usage_ex">
                                                    ...
                                                    <div class="col-md-4">
                                                       ...
                                                       <select class="form-control select2" name="typeof_le" id="typeof_le">
                                                         <option value="0">Select</option>
                                                    ...
                                                    <div class="col-md-4">
                                                        <label>Coating</label>
                                                       <select class="form-control select2" name="coating_id" id="coating_id">
                                                         <option value="0">Select</option>
                                                         <?php if($Get_coating){
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card-content">
                                            ...
                                            <div class="tab-content col-md-12 px-1 pt-1">
                                                <?php if ($checkupdoctorname) {
                                                    $sl = 1;
                                                    foreach ($checkupdoctorname as $data) { ?>
                                       ...
                                       <td><input type="text" class="form-control" id="days_' + row_num + '" name="days[]" value="' + data.getdata[0]['days'] + '"></td>\n\
                                        ...
                                        <td style="display:none;"><input type="date" class="form-control" id="sdate_' + row_num + '" name="sdate[]" value="' + cd + '"></td>\n\
                                         <td style="display:none;"><input type="date" class="form-control" id="tdate_' + row_num + '" name="tdate[]" value="' + cd + '"></td>\n\
                                          <td style="display:none;"><select class="form-control" name="medeye[]" id="medeye_' + row_num + '"><option value="BE">BE</option><option value="LE">LE</option><option value="RE">RE</option><option value="A/F">A/F</option><option value="B/F">B/F</option></select></td>\n\
                                           <td>\n\
                    ...
                    if (data.msg != '') {
                        $('#productdia_details').children('tbody').append('<tr>\n\
                                       ...
                                       <td style="display:none;">' + data.getdata[0]['deptname'] + '<input type="hidden" class="form-control" id="diagnosiss_id_' + row_num_dia + '" name="diagnosiss_id[]" value="' + val + '"><input type="hidden" class="form-control" id="dia_ex_id_' + row_num_dia + '" name="dia_ex_id[]" value="' + exid + '"></td>\n\
                                          <td style="display:none;"><select class="form-control" name="diaeye[]" id="diaeye_' + row_num_dia + '"><option value="BE">BE</option><option value="LE">LE</option><option value="RE">RE</option></select></td>\n\
                                           <td>\n\
                                            <a  onclick="$(this).parent().parent().remove();calcnet();" class="input_column">\n\
                                            <button class="btn btn-danger btnDelete btn-sm">\n\
                                               <i class="la la-trash"></i>\n\
            ...
            function saveframetype()
{
    ...
    function addpartisave() {
     ...
     function getpartisave_PARTI() {
        $('#inv_data_show').html('');
        $("#overlay").fadeIn(300);
        $.ajax({
            type: "POST",
            url: 'getpartisave_PARTI',
            dataType: "json",
             data: {
            ...
            success: function(data) {
                $("#overlay").fadeOut(300);
                $('#inv_data_show').html(data.showdata);
...
function getaddhistorydata_newfun(key)
{
     $('#com_data_show').html('');
      $.ajax({
            type: "POST",
            url: 'Get_new_his_data',
            dataType: "json",
            data: {
                key: key,
                csrf_test_name: csrf
            ...
            success: function(data) {
                ...
                if (data.msg != '') 
                {
                    $('#com_data_show').html(data.showdata);
                } 
            ...
            success: function(data) {
                ...
                if (data.msg != '') {
                    getaddhistorydata(data.key);
                     getaddhistorydata_newfun(data.key);
                    Swal.fire({
                        title: "",
                        text: "" + data.msg + "",
                        type: "success",
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.msg != '') {
                    ...
                    $('#treatment_plan').val(data.mastertable[0]['treatment_plan']);
                    $('#instruction').val(data.mastertable[0]['instruction']);

                    $('#current_meditation').val(data.mastertable[0]['current_meditation']);
                    $("#doctor_id").val(data.mastertable[0]['doctor_id']).trigger("change");
                    $('#past_dental_remarks').val(data.mastertable[0]['past_dental_remarks']);
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.msg != '') {
                        ...
                        window.location.href = "https://<?php echo $host_tvm; ?>.argmedicals.com/master/Dashboard";
                    } else if (data.error != '') {
                        Swal.fire({
                            title: "Warning!",
                            text: "" + data.error + "",
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.msg != '') {
                        ...
                        if (doc_examination_id > 0) {
                                    window.location.href = "https://<?php echo $host_tvm; ?>.argmedicals.com/master/Dental_doctor_appointment";
                                 }
                                 else
                                 {
                                    window.location.href = "https://<?php echo $host_tvm; ?>.argmedicals.com/master/Dashboard";
...
function loadautocomplete(product, val) {
 ...
 $("#overlay").fadeOut(300);
    ...
    {   
        ...
        tablerow=$('#treatmentrow').val();    
        if(tablerow)
        {
            tabrow=parseInt(tablerow)+parseInt(1);
        }   
                      
        var html = '<tr>\n\
                        <td><input type="date" class="form-control datepic" name="treatment_date[]" id="treatment_date'+tabrow+'"></td>\n\
                        <td><input type="text" class="form-control" name="treatmentplansection[]" id="treatmentplansection'+tabrow+'"></td>\n\
                        <td><input type="text" class="form-control" name="paymentmode[]" id="paymentmode'+tabrow+'"></td>\n\
                    <td>\n\
                        <a href="#" onclick="$(this).parent().parent().remove();" class="input_column">\n\
                        <button class="btn btn-danger btnDelete btn-sm">\n\
                           <i class="la la-trash"></i>\n\
            ...
            $('#treatmentplantable').children('tbody').append(html);
            $('#treatmentrow').val(tabrow);
            $('.datepic').val(cd);
    }
