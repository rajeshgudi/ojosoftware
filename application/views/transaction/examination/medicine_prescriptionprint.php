...
<!--                 <td style="text-align:center;font-weight:bold;width:20%"><p style="width:20%">&nbsp;</p>
 ...
 $comname='';
                    ...
                    else
                    {
                        ...
                        $sql = "select  composition.name as compname  from item_master  inner join composition on composition.composition_id=item_master.composition_id where item_master.name like '%$drugname%' ";
                        $result_row = $this->pharmdb->query($sql);
                        $res = $result_row->result_array();
                       // print_r($res);exit;
                       if($res)
                       {
                        $comname=$res[0]['compname'];
                       }
                    }
                    ...
                    ?>
                        <tr>
                            <td><?php echo $sl; ?></td>
                            <td><?php echo $comname; ?> <?php echo $drugname; ?></td>
