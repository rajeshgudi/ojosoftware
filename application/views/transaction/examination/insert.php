                                ...
                                <div id="add_modal_view_screen">
                                    <form id="examination_saveform" action="#" method="post">
                                        ...
                                        <div class="row alert bg-primary alert-dismissible mb-2">
                                            <div class="col-md-10">
                                                <h5 style="color:#fff;"> Patient Name: <?= $pname ?> MRD NO:<?= $mrdno ?> Age : <?= $ageyy ?> Y <?= $agemm ?> M Gender : <?= $gender ?> <?= $address ?> </h5>
                                            </div>
                                            <div class="col-md-2">
                                                                    ...
                                                                    <tr>
                                                                        <td style="display:flex;"><input type="hidden" name="eye_complaints_id[]" value="<?php echo $data['eye_complaints_id']; ?>" class="form-control">
                                                                            <select style="width:100%;" class="form-control select2" multiple="multiple" name="righteye[]" id="ryteye_<?php echo $data['eye_complaints_id']; ?>">
                                                                                ...
                                                                                <?php if ($right_eye) {
                                                                                    foreach ($right_eye as $dataright) {
                                                                                        $sel = '';
                                                        ...
                                                        <table class="table table-bordered" id="Vision">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="background: #e0e0e057;">
                                                                    <select class="form-control select2 Vis_2_1" name="vis1" id="vis1" style="width:100%;">
                                                                        <option value="0">Select</option>
                                                                    </select>
                                                                    <!-- <input ondblclick="getrefractiondata(1,1,2,1)" type="text" name="vis1" id="vis1" class="form-control">
                                                                    <input ondblclick="getrefractiondata(1,1,2,1)" type="text" name="vis1" id="vis1" class="form-control"> -->
                                                                </td>
                                                                <td style="background: #e0e0e057;">
                                                                    <select class="form-control select2 Vis_1_2" name="vis2" id="vis2" style="width:100%;">
                                                                        <option value="0">Select</option>
                                                                    </select>
                                                                    <!-- <input type="text" name="vis2" ondblclick="getrefractiondata(1,2,2,1)" id="vis2" class="form-control"> -->
                                                                </td>
                                                                <td style="background: whitesmoke;">
                                                                    <select class="form-control select2 Vis_1_3" name="vis3" id="vis3" style="width:100%;">
                                                                        <option value="0">Select</option>
                                                                    </select>
                                                                    <!-- <input type="text" name="vis3" id="vis3" class="form-control" ondblclick="getrefractiondata(2,0,2,3)"> -->
                                                                </td>
                                                                <td style="background: #ddd;">
                                                                    <select class="form-control select2 Vis_2_3" name="vis4" id="vis4" style="width:100%;">
                                                                        <option value="0">Select</option>
                                                                    </select>
                                                                    <!-- <input type="text" name="vis4" id="vis4" class="form-control" ondblclick="getrefractiondata(3,3,2,2)"> -->
                                                                </td>
                                                                <td style="background: #ddd;">
                                                                    <select class="form-control select2 Vis_1_4" name="vis5" id="vis5" style="width:100%;">
                                                                        <option value="0">Select</option>
                                                                    </select>
                                                                    <!-- <input type="text" name="vis5" id="vis5" class="form-control" ondblclick="getrefractiondata(3,4,2,2)"> -->
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="background: #faebd747;">Left Eye</td>
                                                                <td style="background: #e0e0e057;">
                                                                    <select class="form-control select2 Vis_2_1" name="vis6" id="vis6" style="width:100%;">
                                                                        <option value="0">Select</option>
                                                                    </select>
                                                                    <!-- <input type="text" ondblclick="getrefractiondata(1,1,1,1)" name="vis6" id="vis6" class="form-control"> -->
                                                                </td>
                                                                <td style="background: #e0e0e057;">
                                                                    <select class="form-control select2 Vis_1_2" name="vis7" id="vis7" style="width:100%;">
                                                                        <option value="0">Select</option>
                                                                    </select>
                                                                    <!-- <input type="text" ondblclick="getrefractiondata(1,2,1,1)" name="vis7" id="vis7" class="form-control"> -->
                                                                </td>
                                                                <td style="background: whitesmoke;">
                                                                    <select class="form-control select2 Vis_1_3" name="vis8" id="vis8" style="width:100%;">
                                                                        <option value="0">Select</option>
                                                                    </select>
                                                                    <!-- <input type="text" ondblclick="getrefractiondata(2,0,1,3)" name="vis8" id="vis8" class="form-control"> -->
                                                                </td>
                                                                <td style="background: #ddd;">
                                                                    <select class="form-control select2 Vis_1_3" name="vis9" id="vis9" style="width:100%;">
                                                                        <option value="0">Select</option>
                                                                    </select>
                                                                    <!-- <input type="text" name="vis9" id="vis9" class="form-control" ondblclick="getrefractiondata(3,3,1,2)"> -->
                                                                </td>
                                                                <td style="background: #ddd;">
                                                                    <select class="form-control select2 Vis_1_4" name="vis10" id="vis10" style="width:100%;">
                                                                        <option value="0">Select</option>
                                                                    </select>
                                                                    <!-- <input type="text" name="vis10" id="vis10" class="form-control" ondblclick="getrefractiondata(3,4,1,2)"> -->
                                                                </td>
                                                            </tr>
                                                        </table>
                                                            ...
                                                            <tr>
                                                                <td style="padding: 0px;">
                                                                    <table class="">
                                                                        ...
                                                                        <tr>
                                                                            <td style="background: #e0e0e057;" class="tab_tit"><?php if ($host_tvm == 'pefemr') {
                                                                                                                                    echo "ADD";
                                                                                                                                } else {
                                                                                                                                    echo "N.V";
                                                                                                                                } ?></td>
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input style="float: left;" type="checkbox" name="select-all" id="select-all">
                                                    <h5 style="font-weight: bold;">Select All</h5>
...
<div class="row">
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.msg != '') {
                        ...
                        for (var i in prop) {
                            var propdata = prop[i];
                            for (var innerpropdata in propdata) {
                                select = $(".Vis_" + i + "_" + innerpropdata);
                                select.select2({
                                    tags: true
                                });
                                var options = prop[i][innerpropdata].map(function(item) {
                                    return {
                                        id: item,
                                        text: item
                                    };
                                ...
                                options.forEach(function(option) {
                                    ...
                                    var optionElement = new Option(option.text, option.id, false, false);
        ...
        function saved_ph_temp() {
            ...
            $.ajax({
                ...
                dataType: "json",
                data: {
                    med_ph_temp_iid: $('#med_ph_temp_iid').val(),
                    row_num: row_num,
    ...
    <style>
        ...
        #show_Injection_part_filter,
        #show_Laser_part_filter,
        .dataTables_info,
        #show_Injection_part_paginate,
        #show_Laser_part_paginate,
        #show_Injection_part_wrapper .dt-buttons,
        #show_Laser_part_wrapper .dt-buttons {
            display: none;
        }
