                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                     <h4 class="card-title">Total Combined  Report</h4>
                                </div>
                            ...
                            <div role="tabpanel" class="tab-pane active" id="tab1" aria-expanded="true" aria-labelledby="base-tab1">
                             <form id="summary" action="#" method="post"> 
                               ...
                               <div class="row">
                                 <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="lastname">List: <span class="text-danger">*</span></label>
                                           <select class="form-control" name="list_op" id="list_op">
                                              <option value="1">EMR COLLECTION</option>
                                              <option value="2">OPTICAL COLLECTION</option>
                                              <option value="3">PHARMACY COLLECTION</option>
                                              <option value="4">OPTICAL GST</option>
                                       ...
                                       <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="lastname">From Date: <span class="text-danger">*</span></label>
                                            <input type="date" name="sum_fromdate" id="det_fromdate" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="lastname">To Date: <span class="text-danger">*</span></label>
                                            <input type="date" name="sum_todate" id="det_todate" class="form-control">
                                        </div>
                                    </div>
...
$.fn.dataTable.ext.errMode = 'none';
        $("#overlay").fadeIn(300);
        saveurl="Total_combined_report/getsummary";
         $.ajax({
            type: "POST",
            url: saveurl,
            dataType: "json",
...
$.fn.dataTable.ext.errMode = 'none';
        ...
        else if($('#list_op').val()==2)
        {
            saveurl="Total_combined_report/op_getsummary";
        }
        else if($('#list_op').val()==4)
        {
            saveurl="Total_combined_report/getgstreport_op";
        }
        else if($('#list_op').val()==5)
        {
            saveurl="Total_combined_report/getgstreport_ph";
        }
        else
        {
            saveurl="Total_combined_report/getsummary_ph";
        }
      // alert(saveurl);
         $.ajax({
            type: "POST",
