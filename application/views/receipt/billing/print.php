...
<html>
    ...
    <body>
          ...
          <tr>
             ...
             <table  width="100%" style="line-height:15px;font-size: 12;height: 100%;border-left: 1px solid black;border-right:  1px solid black;border-top: 1px solid black" >
                ...
                <tr>
                    ...
                    <td style="border-bottom:1px solid black;text-align: right;">Total</td>
     ...
     ?>
            ...
            <td style="border-bottom: 1px solid black;text-align: right;"><?= number_format($data->amount,2); ?>
