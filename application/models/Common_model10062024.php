...
class Common_model extends CI_Model{
 ...
 public function __construct()
	...
	function getPat($searchTerm="",$serv=""){
...
where medicine_id='$var_array[0]'    and medicine.status=1
...

    {
        ...
        $sql = "select fname,lname,mrdno,CONCAT(`fname`,' ', `lname`) AS pname,ageyy,address from patient_registration where  patient_registration_id=? and  office_id= ?";
