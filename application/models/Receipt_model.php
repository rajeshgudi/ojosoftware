...
class Receipt_model extends CI_Model{
 ...
 public function __construct()
...

  {
    ...
    $this->db->select('bill_amount');//s.photo_no,s.photo_name'
    $this->db->select('advanced_amount');
    ...
    $sql = "SELECT billing_master_id,billing_master.invoice_number,CONCAT(fname , '',  lname ,'') AS pateint_name,billing_date,advanced_amount,grand_total,modeofpay.name as mode";
 ...
 $print='<button onclick="printdata('.$billing_master_id.')" type="button" class="btn btn-icon btn-info mr-1 mb-1"><i class="la la-print"></i></button>';
  ...
  { error_reporting(0);
   ...
   $data['balance']=($billing_masters->bill_amount-$billing_masters->advanced_amount);
   ...
   $data['net_amount_in_words']= $this->numberTowords($billing_masters->advanced_amount);
  ...
  $data['particulars_details']=$this->db->query("select * from billing_detail where billing_master_id=$billing_id")->result();                
         ...
         switch($patient_details->print)
            ...
            case 1:$html=$this->load->view("receipt/billing/print",$data, true); 
            ...
            case 2:$html=$this->load->view("receipt/billing/print",$data, true); 
           ...
           case 3:$html=$this->load->view("receipt/billing/print",$data, true); 
              ...
              case 4:$html=$this->load->view("receipt/billing/print",$data, true); 
