 ...
 */
class Psychiatrist_doctor_appointment_model extends CI_Model{
 public function __construct()
  ...
  public function getcomp($search_date,$doctor_id)
     ...
     public function getexaminationindividualdatafromdashboard($var_array,$doid)
    {
        ...
        if($doid)
        {
            $wh= " and  psychiatrist_process.doctor_id=$doid";
        }
        $sql = "select psychiatrist_process.patient_appointment_id,psychiatrist_process.patient_registration_id,DATE_FORMAT(psychiatrist_date,'%d/%m/%Y') AS psychiatrist_date,psychiatrist_process.psychiatrist_process_id,doctors_registration.name as doctorname,CONCAT(fname , ' ',  lname ,'') AS pateint_name,mrdno,gender,ageyy,agemm,patient_registration.mobileno,psychiatrist_process.doctor_id  from psychiatrist_process inner join patient_registration on patient_registration.patient_registration_id=psychiatrist_process.patient_registration_id left join doctors_registration on doctors_registration.doctors_registration_id=psychiatrist_process.doctor_id where  psychiatrist_process.psychiatrist_date= ?  and   psychiatrist_process.office_id= ?  $wh order by psychiatrist_process_id DESC";
    ...
    public function deletedata($id) 
    {
        ...
        if($this->db->delete('psychiatrist_process'))
        {
            $this->db->where('psychiatrist_process_id', $id);
