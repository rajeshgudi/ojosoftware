...
class Psychiatrist_doctor_appointment extends CI_Controller {
  ...
  public function __construct() {
	...
	public function index()
	{
      ...
      $content=$this->load->view('master/psychiatrist_doctor_appointment',$data,true);
  ...
  public function Get_appointmentdata()
  {
    ...
    if($search_date)
    {
        $html='';
        $sl=1;
        $getresult=$this->Psychiatrist_doctor_appointment_model->getAppointment($search_date,$doctor_id);
        if($getresult)
        {
  ...
  public function Get_Dental_comp()
  {
    ...
    if($search_date)
    {
        $html='';
        $i=1;
        $getresult=$this->Psychiatrist_doctor_appointment_model->getcomp($search_date,$doctor_id);
        if($getresult)
        {
