...
class Medicine_instruction extends CI_Controller {
  public function __construct() {
        ...
        $this->load->model('Medicine_instruction_model');
    ...
    {
        $param=$_REQUEST;
        $response=$this->Medicine_instruction_model->ajax_call($param);
        echo json_encode($response);
    }
	public function index()
	{
      $data['title']='EMR::Medicine Instruction';
      $data['activecls']='Medicine_instruction';
      ...
      $content=$this->load->view('master/medicine_instruction',$data,true);
    ...
    private function fetch_data() 
    {
        ...
        return array(
            ...
            'days'=>trim($this->input->post('nodays')),
    ...
    public function savedata()
	{
	    ...
	    if($this->form_validation->run() == TRUE)
	    {
	    	...
	    	$chk_duplication=$this->Medicine_instruction_model->checkingval($var_array);
	    	if($chk_duplication[0]['cnt']==0)
	    	{
	    		$data=$this->fetch_data();
	    		$getresult=$this->Medicine_instruction_model->savedata($data);
	    		if($getresult)
	    		{
	...
	public function editdata()
	{
		...
		if($this->form_validation->run() == TRUE)
	    {
	    	...
	    	$getdata=$this->Medicine_instruction_model->geteditdata($var_array);
	    	if($getdata)
	    	{
	    		$html=$medc=$medct='';
							                ...
							                <div class="modal-body">
							                    <div class="row">
							                        <div class="col-lg-12 col-md-12" >
							                          <input type="hidden" name="id" id="id" value="'.$data['medicine_instruction_id'].'">
							                           <input type="hidden" name="csrf_test_name" id="csrf_test_name" value="'.$this->security->get_csrf_hash().'"> 
							                                 
							                                 <div class="row col-md-12">
							                                   <div class="col-md-12 form-group">
							                                         <label for="lastname">Instruction: <span class="text-danger">*</span></label>
							                                ...
							                                <div class="row col-md-12">
							                                   <div class="col-md-12 form-group">
							                                          <label for="lastname">Category: <span class="text-danger">*</span></label>
                                           							<select class="form-control select2" id="medicine_category_id" name="medicine_category_id">
							                                 ...
							                                 <div class="row col-md-12">
							                                   <div class="col-md-12 form-group">
							                                          <label for="lastname">No Of days: <span class="text-danger">*</span></label>
                                           							 <input type="text" class="form-control"  id="nodays" name="nodays" value="'.$data['days'].'">
							                                    </div>
							                                </div>
	...
	public function updatedata()
	{
	    ...
	    if($this->form_validation->run() == TRUE)
	    {
	    	...
	    	$chk_duplication=$this->Medicine_instruction_model->editcheck($var_array);
	    	if($chk_duplication[0]['cnt']==0)
	    	{
	    		$data=$this->fetch_data();
	    		$getresult=$this->Medicine_instruction_model->updatedata($data,$edit_id);
	    		if($getresult)
	    		{
	...
	public function deletedata()
	{
	    ...
	    if($this->form_validation->run() == TRUE)
	    {
	    	...
	    	$chk_duplication=$this->Medicine_instruction_model->deletecheck($var_array);
	    	if($chk_duplication[0]['cnt']==1)
	    	{
	    		$getresult=$this->Medicine_instruction_model->deletedata($delete_id);
	    		if($getresult)
	    		{
